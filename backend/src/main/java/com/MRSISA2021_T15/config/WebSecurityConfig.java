	...
	protected void configure(HttpSecurity http) throws Exception {
		http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and()
			...
			.authorizeRequests().antMatchers("/auth/login").permitAll()
				...
				.antMatchers("/suppliers/getSupplierData/{supplierUsername}").hasAuthority("ROLE_SUPPLIER")
				...
				.antMatchers("/calendar/calendarPharmacist/{pharmacistId}").hasAuthority("ROLE_PHARMACIST")
				.antMatchers("/calendar/calendarDermatologist/id={dermatologistId}pharmacy={pharmacyId}").hasAuthority("ROLE_DERMATOLOGIST")
				.antMatchers("/calendar/calendarDermatologist/{dermatologistId}").hasAuthority("ROLE_DERMATOLOGIST")
				.antMatchers("/calendar/calendarDermatologistPredefined/{dermatologistId}").hasAuthority("ROLE_DERMATOLOGIST")
				.antMatchers("/calendar/calendarDermatologistPredefined/id={dId}/pharmacy={pId}").hasAuthority("ROLE_DERMATOLOGIST")
				...
				.antMatchers("/patient-search/searchPatientsPharmacist/{pharmacistId}").hasAuthority("ROLE_PHARMACIST")
				.antMatchers("/patient-search/searchPatientsDermatologist/{dermatologistId}").hasAuthority("ROLE_DERMATOLOGIST")
				...
				.antMatchers("/pharmacist/get/{pharmacistId}").hasAuthority("ROLE_PHARMACIST")
